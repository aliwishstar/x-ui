...
func (s *ServerService) GetXrayVersions() ([]string, error) {
	url := "https://api.github.com/repos/aliwishstar/Xray-core/releases"
...
func (s *ServerService) downloadXRay(version string) (string, error) {
	...
	url := fmt.Sprintf("https://github.com/aliwishstar/Xray-core/releases/download/%s/%s", version, fileName)
	resp, err := http.Get(url)
	if err != nil {
		return "", err
	}
